...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='endeffector_control_node',
            name='endeffector_control_node',
            output='screen',
            parameters=[
        ...
        Node(
            package='arm_endeffector_control',
            executable='cartesian_path_planner',
